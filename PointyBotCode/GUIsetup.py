...
def displaySettings():
	buttons = {'Update Position':(160,110),'Quit':(60,200),'Reboot':(140,200),'Power Off':(250,200),'Home':(280,30)}
	otherText = {'PointyBox!':(100,50)}
	return [buttons, otherText]

#"Targets Screen" (options for different targets, currently ISS, ECE 5725 Lab, My House, Kristina's House)
def displayTargets():
	buttons = {'ISS Tracking':(160,200),'Point At ECE5725 Lab':(160,120),'Point At Kristinas House':(160,160), 'Point at Cuylers House':(160,80),'Home':(280,30)} 
	otherText = {'PointyBox!':(80,50)}
        return [buttons, otherText]
